...
function [s] = busquedasIncr(x0,Delta,niter)
    %aca le podemos poner un parametro de string para poder ingresar la ecuacion
    fprintf("entra en el de la busquedas incrementales");
    syms f(x)
    f(x)=cos(x)-x^2;
    f0=f(x0);
    if f==0
